...
"}"));
        ...
        gridLayout->addItem(horizontalSpacer, 1, 4, 3, 1);
        ...
        gridLayout->addWidget(line, 0, 5, 4, 1);
        ...
        font3.setBold(true);
        hpld_curr_label_0->setFont(font3);
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, label_47);
        ...
        tec_temp_0_label->setFont(font3);

        formLayout->setWidget(4, QFormLayout::FieldRole, tec_temp_0_label);
        ...
        formLayout->setWidget(5, QFormLayout::LabelRole, label_49);
        ...
        tec_temp_1_label->setFont(font3);

        formLayout->setWidget(5, QFormLayout::FieldRole, tec_temp_1_label);
        ...
        volt_amp_ext_label->setFont(font3);

        formLayout->setWidget(6, QFormLayout::FieldRole, volt_amp_ext_label);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, label_39);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, backward_treashold_label);
        ...
        hpld_curr_label_1->setFont(font3);
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, label_52);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, therm_resis_label);
        ...
        gridLayout->addLayout(verticalLayout_16, 0, 6, 4, 1);
        ...
        sizePolicy2.setHeightForWidth(tec_temp_0->sizePolicy().hasHeightForWidth());
        tec_temp_0->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(tec_temp_1->sizePolicy().hasHeightForWidth());
        tec_temp_1->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(hpld_curr_0->sizePolicy().hasHeightForWidth());
        hpld_curr_0->setSizePolicy(sizePolicy2);
        hpld_curr_0->setMinimumSize(QSize(50, 0));
        hpld_curr_0->setMaximumSize(QSize(16777215, 16777215));
        hpld_curr_0->setFont(font5);
        ...
        sizePolicy2.setHeightForWidth(hpld_curr_1->sizePolicy().hasHeightForWidth());
        hpld_curr_1->setSizePolicy(sizePolicy2);
        hpld_curr_1->setMinimumSize(QSize(50, 0));
        hpld_curr_1->setMaximumSize(QSize(16777215, 16777215));
        hpld_curr_1->setFont(font5);
        ...
        gridLayout->addWidget(groupBox_12, 0, 3, 1, 1);
        ...
        gridLayout->addWidget(groupBox_16, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(groupBox_14, 1, 3, 1, 1);
        ...
        sizePolicy2.setHeightForWidth(volt_amp_ext->sizePolicy().hasHeightForWidth());
        volt_amp_ext->setSizePolicy(sizePolicy2);
        volt_amp_ext->setMinimumSize(QSize(50, 0));
        volt_amp_ext->setMaximumSize(QSize(16777215, 16777215));
        volt_amp_ext->setFont(font5);
        ...
        gridLayout->addWidget(groupBox_17, 2, 0, 1, 1);
        ...
        gridLayout->addWidget(groupBox_19, 2, 3, 1, 1);
    ...
    void retranslateUi(QWidget *cb_panel)
    {
        ...
        label_38->setText(QCoreApplication::translate("cb_panel", "Forward lvl. :", nullptr));
        ...
        label_39->setText(QCoreApplication::translate("cb_panel", "Backward lvl.:", nullptr));
        ...
        label_53->setText(QCoreApplication::translate("cb_panel", "Beta thermistor:", nullptr));
        label_54->setText(QCoreApplication::translate("cb_panel", "Vref thermistor:", nullptr));
